		...
		<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
			<div class="am-offcanvas-bar admin-offcanvas-bar">
				<ul class="am-list admin-sidebar-list">
					...
					<li><a href="uplo.action"><span
							class="am-icon-pencil-square-o"></span> 上传教学视频</a></li>
				</ul>
			...
			<div class="admin-content-body">
				<div class="am-cf am-padding am-padding-bottom-0">
					<div class="am-fl am-cf">
						<strong class="am-text-primary am-text-lg">教师</strong> / <small>练习题</small>
					</div>
				</div>
					...
					<s:form action="option" 
						...
						<fieldset>
							...
							<div class="am-form-group">
								<label for="doc-ipt-email-1">练习名</label> <input type="text"
									class="" name="lianname" placeholder="练习名">
							</div>
							...
							<div class="am-form-group">
                              ...
                              <div class="am-form-group" id="change">
                               ...
                               <div class="am-form-group">
								<label for="doc-ipt-email-1">练习题目</label> <input type="text"
